...
/*   Updated: 2025/06/27 12:34:02 by aobshatk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target)
{
	if (this->_energy > 0 && this->_health > 0)
	{
		if (!(this->_name.empty()))
			...
			std::cout << "ClapTrap " << "Anonimous attacks " << target << " causing " << this->_damage << " points of damage " << std::endl;
		this->_energy -= 1;
	}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energy > 0 && this->_health > 0)
	{
		if (!(this->_name.empty()))
			...
			std::cout << "ClapTrap " << "Anonimous is repairing " << amount << " points of health " << std::endl;
		this->_energy -= 1;
	}
	else if (this->_energy <= 0)
		std::cout << "Not enough energy to attack\n";
